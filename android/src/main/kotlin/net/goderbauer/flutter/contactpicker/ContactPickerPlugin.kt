...
/** ContactPickerPlugin */
class ContactPickerPlugin: FlutterPlugin, MethodCallHandler,
...
//    val label = ContactsContract.CommonDataKinds.Email.getTypeLabel(activity?.getResources(), phoneType, customLabel) as String
